...
@RestController
@RequestMapping("/api/auth/geminiPro")
@RequiredArgsConstructor
@Tag(name = "Gemini Controller Pro", description = "Endpoints for Gemini operations")
public class GeminiControllerPro {
    ...
    public GeminiResponseWithImage getCompletionWithOrganicFertilizerAdviceAM(
